...
wget https://github.com/Luciliosantos/Luciliosantos/raw/main/Painel-V2022/gestorssh.zip > /dev/null 2>&1
...
sleep 1
cd || exit
wget https://github.com/Luciliosantos/Luciliosantos/raw/main/Painel-V2022/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
clear
sleep 1
echo -e "\033[1;32m MULTIHD-SSH INSTALADO COM SUCESSO!"
echo ""
echo -e "                 \033[1;31mBy @Sr_Luciliosantos\033[1;36m"
echo ""
