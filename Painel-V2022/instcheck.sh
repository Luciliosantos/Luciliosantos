...
echo ""
echo -e "                 \033[1;31mBy @Sr_Luciliosantos\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://github.com/Luciliosantos/Luciliosantos/raw/main/Painel-V2022/chuser > /dev/null 2>&1
wget https://github.com/Luciliosantos/Luciliosantos/raw/main/Painel-V2022/userscheck > /dev/null 2>&1
...
wget https://github.com/Luciliosantos/Luciliosantos/raw/main/Painel-V2022/checkuser.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@Sr_Luciliosantos\033[0m"
